...
# Stop hook: 「完了」宣言時に pytest 実行証跡なければ警告ログ + Pushover通知
# ブロックはしない（警告のみ・exit 0）

set -uo pipefail

PUSHOVER_TOKEN="a5rb9ipb3yrdanv3vk4n8x28qt7io9"
PUSHOVER_USER="u2cevk8nktib3sr148rw2hs78ecvux"
LOG=/Users/yuusakuichio/trading/data/logs/false_claim_detected.log
mkdir -p "$(dirname "$LOG")"
