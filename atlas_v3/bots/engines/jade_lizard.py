...
class JadeLizardTactic(TacticBase):
    ...
    def should_exit(
        ...
        sl_dyn = get_dynamic_stop_loss(env.vix, self._cfg.stop_loss_multiplier)
        profit_threshold = position.total_credit * pt_dyn
        loss_threshold = -position.total_credit * sl_dyn
